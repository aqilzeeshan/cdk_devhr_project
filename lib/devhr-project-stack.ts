...
import { AuthorizationType,Authorizer,PassthroughBehavior} from '@aws-cdk/aws-apigateway';
...
export class DevhrProjectStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    //remove it so that rekFn gets triggered by SQS
  ...
  ​
    ...
    //lets us allow to make unauthenticated requests in cognito
    ...
    //based on CUP (Cognito User Pool) Token identityPool provides AWS credentials so user can access AWS resources
    ...
    //telling API gateway that we are going to use Authorizer 
    ...
    ​
    // GET /images
    //curl -X GET 'https://l85na5t04i.execute-api.us-east-1.amazonaws.com/prod/images?action=getLabels&key=bun.png'
    ...
    // DELETE /images
    //curl -X DELETE 'https://l85na5t04i.execute-api.us-east-1.amazonaws.com/prod/images?action=deleteImage&key=bun.png'
